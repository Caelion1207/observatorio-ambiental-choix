/**
 * Funciones únicas de cálculo de métricas estructurales (Frontend)
 * 
 * Este archivo contiene las funciones canónicas para calcular IRM, brechas y nivel de incertidumbre en el frontend.
 * TODAS las vistas (dominio, investigación individual, resumen) DEBEN consumir estas funciones.
 * 
 * NO crear cálculos paralelos en otros componentes.
 */
...
/**
 * Formatea IRM para visualización
 * 
 * @param irm - Índice de Robustez Metodológica (0-1) o null
 * @returns String formateado (ej: "0.55" o "N/A")
 */
export function formatearIRM(irm: number | null): string {
  if (irm === null) {
    return "N/A";
  }
